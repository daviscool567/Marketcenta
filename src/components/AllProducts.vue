        ...
        <ion-row class="products-wrapper">
            <ion-col size="6" class="product-div" v-for="(product, i) in p_data" :key="i">
                <ion-card class="product-card">
                    <!-- <div @click="navigate_url(product.item_id)"> -->
                    ...
                    <ion-card-content class="product-content">
                        ...
                        <span style="font-size: 13px; font-weight: 600; opacity: 0.9; color: #17a2b8" v-if="product.product_rating[0].avg">
                            <vue3-star-ratings
                                :step="0.5"
                                :starSize="15"
                                :disableClick="true"
...
export default defineComponent({
    ...
    methods: {
        ...
        navigate_url(item_id){
            this.$router.push({name: 'SingleProduct', params:{product_id: item_id}})
        },
        // buyNow() {
        //     this.value = true
        // },
