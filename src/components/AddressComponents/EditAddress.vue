<template>
    <ion-content>
        ...
        <form @submit.prevent="updateAddress" class=" mt-4">
            <div>
                <ion-item>
                ...
                <ion-item class="mt-3">
                    ...
                    <ion-input type="text" v-model="form.second_number"></ion-input>
                </ion-item>
                <ion-item class="mt-3">
                    <ion-label position="floating">Street Address</ion-label>
                    <ion-input type="text" v-model="form.street_address"></ion-input>
                </ion-item>
                <ion-item class="mt-3">
                    <ion-label position="floating">Direction / Landmark</ion-label>
                    <ion-input type="text" v-model="form.direction"></ion-input>
                </ion-item>
                <ion-item class="mt-3">
                    <ion-label>City</ion-label>
                    <ion-select v-model="form.city_id" ok-text="Select" cancel-text="Cancel" required>
...
export default defineComponent({
    ...
    methods: {
        ...
        updateAddress() {
            ...
            axios
                .post(this.dynamic_auth_route("user/address/update"), this.form, {
                headers: {
                    authorization: `Bearer ${this.auth_token}`,
                },
                })
